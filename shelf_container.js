...
var characters = ['Alm', 'Arwing', 'Barioth & Ayuria', 'Bayonetta', 'Boo', 'Bowser Jr', 'Bowser', 'Captain Falcon', 'Celica', 'Charizard', 'Chibi Robo', 'Chrom (FE) (JP)', 'Chrom (FE)', 'Chrom', 'Cloud', 'Corrin (Female)', 'Corrin (Male)', 'Daisy (Super Mario)', 'Daisy', 'Dark Pit', 'Dark Samus', 'Diddy Kong', 'Donkey Kong', 'Dr Mario', 'Duck Hunt', 'Falco', 'Fox', 'Game and Watch', 'Ganondorf', 'Goomba', 'Greninja', 'Ice Climbers', 'Ike', 'Inkling', 'Ivysaur', 'Jigglypuff', 'King Dedede', 'King K Rool', 'King Knight', 'Kirby', 'Link (Adult)', 'Link (BOTW)', 'Little Mac', 'Lucario', 'Lucas', 'Lucina', 'Luigi', 'Mario (Gold)', 'Mario (Silver)', 'Mario', 'Marth', 'Mega Man', 'Meta Knight', 'Mewtwo', 'Mii Brawler', 'Mii Gunner', 'Mii Swordfighter', 'Navirou', 'Ness', 'Olimar', 'Pac-Man', 'Palutena', 'Peach', 'Pichu', 'Pikachu', 'Pikmin', 'Pit', 'Plague Knight', 'Pokemon Trainer', 'Qurupeco & Dan', 'Rathalos & Boy', 'Rathalos & Girl', 'Rathian & Cheval', 'Richter', 'Ridley', 'ROB', 'Robin (Male)', 'Rosalina', 'Roy', 'Ryu', 'Samus', 'Sheik', 'Shovel Knight', 'Shulk', 'Simon', 'SM-koopa', 'Snake', 'Sonic', 'Specter Knight', 'splat-boy-2', 'splat-boy-violet', 'splat-boy', 'splat-girl-2', 'splat-girl-green', 'splat-girl', 'splat-green-ENG', 'splat-pink-ENG', 'splat-squid-2', 'splat-squid-oran', 'splat-squid', 'Squirtle', 'Tiki (JP)', 'Toad', 'Toon Link', 'Villager', 'Waddle Dee', 'Waluigi', 'Wario', 'Wii Fit Trainer', 'Wolf', 'Yoshi', 'Young Link', 'YWW-blu', 'YWW-green', 'YWW-pink', 'YWW-poochy', 'Z-botw-daruk', 'Z-botw-mipha', 'Z-botw-revali', 'Z-botw-urbosa', 'Zelda-SSBU', 'Zelda', 'Zero Suit Samus']
var char_options = []
